...
execute @e[type=area_effect_cloud,name=AssemblyArea] ~1 ~1 ~1 fill ~ ~ ~ ~13 ~4 ~13 minecraft:air
...
execute @e[type=area_effect_cloud,name=AssemblyArea] ~ ~ ~ fill ~1 ~1 ~1 ~14 ~5 ~14 structure_void 0 replace air
